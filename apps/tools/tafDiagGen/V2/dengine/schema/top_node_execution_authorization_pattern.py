...
def schema__execution_authorization_pattern(top_node):
    Tname = schema__execution_authorization_pattern.name = "execution_authorization_pattern"
    need_to_stop = False
