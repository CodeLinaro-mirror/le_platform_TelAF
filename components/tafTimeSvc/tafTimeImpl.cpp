...

{
    ...
    int slotId = tafTime.phoneManager->getPhoneIdFromSlotId(handleData->networkNumber);
...
)
{
    ...
    tafTime.NetworkHandlerInfo.networkNumber = phone;
...
)
{
    ...
    taf_time_TimeSources_t sourceId = (slotId == 1)? TAF_TIME_SRC_NAME_NETWORK
