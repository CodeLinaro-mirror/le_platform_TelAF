...
extern std::shared_ptr<tafIvssInfoSvcStubImpl> ivssInfoSvc;

tafIvssInfoSvcStubImpl& tafIvssInfoSvcStubImpl::GetInstance()
{
    static tafIvssInfoSvcStubImpl instance;
    return instance;
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void tafIvssInfoSvcStubImpl::GetImeiHandler
(
    void* reportPtr
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void tafIvssInfoSvcStubImpl::GetImei(const std::shared_ptr<CommonAPI::ClientId> _client,
...
void tafIvssInfoSvcStubImpl::Init
(
    void
)
{
    ...
    GetImeiEventHandlerRef = le_event_AddHandler("GetImeiEvent Handler",
        GetImeiEvent, tafIvssInfoSvcStubImpl::GetImeiHandler);
