...
def schema__authentication_antibruteforce(top_node):
    Tname = schema__authentication_antibruteforce.name = "authentication_antibruteforce"
    need_to_stop = False
    ...
    def check_item(value, key):
        ...
        for required_key, check_fn in {
            "AntiBruteForceCounterMaxValue": Int(),
            "DelayTimerInvokingValueInit": Int(),
            "DelayTimerInvokingValueMax": Int(),
        }.items():
