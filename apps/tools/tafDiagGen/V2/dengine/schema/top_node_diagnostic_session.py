...
def schema__diagnostic_session(top_node):
    Tname = schema__diagnostic_session.name = "diagnostic_session"
    need_to_stop = False
    ...
    def check_item(value, key):
        ...
        for required_key, check_fn in {
            ...
            "id" : Int(), # Hexa
            "p2_server_max": Num(min=0.00, max=65.5),
            "p2_start_server_max": Num(min=0.00, max=65.5),
